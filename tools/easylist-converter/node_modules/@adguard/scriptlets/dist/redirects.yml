...
- title: click2load.html
  ...
  # To enable the redirect functionality to work within the extension
  ...
  sha: sha256-GH4MISem+XXlowF3M/QKqtfEOkhzt1IQoYAZCyE46YU=
...
- title: freewheel-admanager
  comment: Mocks the FreeWheel Ad Manager.
  aliases: []
  contentType: application/javascript
  content: |-
    (function(source, args) {
...
- title: google-ima3-dai
  comment: Mocks the IMA DAI SDK of Google.
  aliases: []
  contentType: application/javascript
  content: |-
    (function(source, args) {
