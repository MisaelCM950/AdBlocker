...
const levelMapNumToString = {
    [1 /* LogLevelNumeric.Error */]: exports.LogLevel.Error,
    [2 /* LogLevelNumeric.Warn */]: exports.LogLevel.Warn,
    [3 /* LogLevelNumeric.Info */]: exports.LogLevel.Info,
    [4 /* LogLevelNumeric.Debug */]: exports.LogLevel.Debug,
    [5 /* LogLevelNumeric.Verbose */]: exports.LogLevel.Verbose,
};
/**
...
class Logger {
     ...
     */
    error(...args) {
        this.print(1 /* LogLevelNumeric.Error */, exports.LogMethod.Error, args);
    }
    /**
     * Print warn messages.
     ...
     */
    warn(...args) {
        this.print(2 /* LogLevelNumeric.Warn */, exports.LogMethod.Warn, args);
    }
    /**
     ...
     */
    info(...args) {
        this.print(3 /* LogLevelNumeric.Info */, exports.LogMethod.Info, args);
    }
    /**
     ...
     */
    debug(...args) {
        this.print(4 /* LogLevelNumeric.Debug */, exports.LogMethod.Debug, args);
    }
    /**
     ...
     */
    trace(...args) {
        this.print(5 /* LogLevelNumeric.Verbose */, exports.LogMethod.Trace, args);
    }
    /**
    ...
    set currentLevel(logLevel) {
        ...
        if (level === undefined) {
            throw new Error(`Logger supports only the following levels: ${[Object.values(exports.LogLevel).join(', ')]}`);
        }
    ...
    print(level, method, args) {
         ...
         * stack trace.
         */
        if (this.currentLevelValue >= levelMapStringToNum[exports.LogLevel.Debug]
            && method !== exports.LogMethod.Error) {
