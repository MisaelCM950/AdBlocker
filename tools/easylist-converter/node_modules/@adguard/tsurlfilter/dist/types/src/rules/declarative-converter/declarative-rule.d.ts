...
import { HTTPMethod } from '../../modifiers/method-modifier.js';
/**
 ...
 * Chrome 128+
 */
declare const HeaderInfoValidator: zod.ZodObject<{
    excludedValues: zod.ZodOptional<zod.ZodArray<zod.ZodString, "many">>;
    header: zod.ZodString;
