 ...
 */
export declare class TooManyRegexpRulesError extends Error {
    /**
     ...
     */
    constructor(message: string, excludedRulesIds: number[], numberOfMaximumRules: number, numberOfExcludedDeclarativeRules: number);
}
