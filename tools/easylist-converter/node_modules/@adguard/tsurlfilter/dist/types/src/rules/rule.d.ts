import { type CosmeticRuleParts, type NetworkRuleParts, type RuleParts } from '../filterlist/rule-parts.js';
/**
 * Default filter list ID for source mapping.
 *
 * It is -1, similar to `Array.indexOf()` return value when element is not found.
 */
export declare const FILTER_LIST_ID_NONE = -1;
/**
 * Default rule index for source mapping.
 *
 * It is -1, similar to `Array.indexOf()` return value when element is not found.
 */
export declare const RULE_INDEX_NONE = -1;
/**
 ...
 * Indexed rule.
 */
export declare class IndexedRule<T> {
    /**
     * Rule.
     */
    rule: T;
 ...
 * Indexed rule parts.
 */
export declare class IndexedRuleParts<T extends RuleParts = RuleParts> {
    /**
     * Rule parts.
     */
    ruleParts: T;
 ...
 */
export declare class IndexedStorageRuleParts<T extends RuleParts = RuleParts> {
    /**
     * Rule parts.
     */
    ruleParts: T;
