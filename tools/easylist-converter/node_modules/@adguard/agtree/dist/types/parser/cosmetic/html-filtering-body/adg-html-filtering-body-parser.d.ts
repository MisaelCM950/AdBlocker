 ...
 */
export declare class AdgHtmlFilteringBodyParser extends BaseParser {
    /**
     ...
     * ```
     */
    static parse(raw: string, options?: import("../../index.js").ParserOptions, baseOffset?: number): Value | HtmlFilteringRuleBody;
}
