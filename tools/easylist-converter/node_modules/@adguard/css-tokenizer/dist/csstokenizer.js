...
function consumeBadUrlToken(context, start) {
    ...
    context.onToken(exports.TokenType.BadUrl, start, context.offset, undefined, context.stop);
}
/**
...
const consumeUrlToken = (context, start) => {
    ...
    while (context.offset <= context.length) {
        ...
        if (context.code === 41 /* CodePoint.RightParenthesis */) {
            ...
            context.onToken(exports.TokenType.Url, start, context.offset, undefined, context.stop);
            return;
        }
        // EOF
        if (context.isEof()) {
...
const consumeIdentLikeToken = (context) => {
    ...
    if (context.code === 40 /* CodePoint.LeftParenthesis */) {
        ...
        if (fnHash === URL_FUNCTION_HASH) {
            ...
            if (nextNonWsCode === 34 /* CodePoint.QuotationMark */ || nextNonWsCode === 39 /* CodePoint.Apostrophe */) {
                context.onToken(exports.TokenType.Function, start, context.offset, undefined, context.stop);
                return;
            }
    ...
    context.onToken(exports.TokenType.Ident, start, context.offset, undefined, context.stop);
};
...
const consumeNumericToken = (context) => {
    ...
    if (checkForIdentStart(context.code, context.nextCode, context.getRelativeCode(2))) {
        ...
        context.onToken(exports.TokenType.Dimension, start, context.offset, undefined, context.stop);
        return;
    }
    ...
    if (context.code === 37 /* CodePoint.PercentageSign */) {
        context.consumeCodePoint();
        context.onToken(exports.TokenType.Percentage, start, context.offset, undefined, context.stop);
        return;
    }
    // Otherwise, create a <number-token> with the same value and type flag as number, and return it.
    context.onToken(exports.TokenType.Number, start, context.offset, undefined, context.stop);
};
    ...
    while (context.isLessThanEqualToEof()) {
        switch (context.code) {
            ...
            case endingCodePoint:
                ...
                context.onToken(exports.TokenType.String, start, context.offset, undefined, context.stop);
                return;
            // EOF
            ...
            case 12 /* CodePoint.FormFeed */:
                ...
                // return it.
                context.onToken(exports.TokenType.BadString, start, context.offset, undefined, context.stop);
...
const consumeWhitespaceToken = (context) => {
    ...
    context.onToken(exports.TokenType.Whitespace, start, context.offset, undefined, context.stop);
};
        ...
        switch (context.code) {
            ...
            case 35 /* CodePoint.NumberSign */:
                ...
                if (isIdentCodePoint(context.getRelativeCode(1))
                    ...
                    context.onToken(exports.TokenType.Hash, start, context.offset, undefined, context.stop);
                    break;
                }
            ...
            case 45 /* CodePoint.HyphenMinus */:
                ...
                if (context.getRelativeCode(1) === 45 /* CodePoint.HyphenMinus */
                    ...
                    context.onToken(exports.TokenType.Cdc, context.offset - 3, context.offset, undefined, context.stop);
                    break;
                }
            ...
            case 60 /* CodePoint.LessThanSign */:
                ...
                if (context.getRelativeCode(1) === 33 /* CodePoint.ExclamationMark */
                    ...
                    context.onToken(exports.TokenType.Cdo, context.offset - 4, context.offset, undefined, context.stop);
                    break;
                }
                // Otherwise, return a <delim-token> with its value set to the current input code point.
                context.consumeTrivialToken(exports.TokenType.Delim);
            ...
            case 64 /* CodePoint.CommercialAt */:
                ...
                if (checkForIdentStart(context.getRelativeCode(1), context.getRelativeCode(2), context.getRelativeCode(3))) {
                    ...
                    consumeIndentSequence(context);
                    context.onToken(exports.TokenType.AtKeyword, start, context.offset, undefined, context.stop);
                    break;
                }
                // Otherwise, return a <delim-token> with its value set to the current input code point.
                context.consumeTrivialToken(exports.TokenType.Delim);
            ...
            case 47 /* CodePoint.Solidus */:
                ...
                if (context.getRelativeCode(1) === 42 /* CodePoint.Asterisk */) {
                    ...
                    context.onToken(exports.TokenType.Comment, start, context.offset, undefined, context.stop);
                    break;
                }
                // Otherwise, return a <delim-token> with its value set to the current input code point.
                context.consumeTrivialToken(exports.TokenType.Delim);
...
const handleRegularExtendedCssPseudo = (context) => {
    ...
    for (let i = start; i < context.offset; i += 1) {
        context.onToken(exports.TokenType.Delim, i, i + 1, undefined, context.stop);
    }
