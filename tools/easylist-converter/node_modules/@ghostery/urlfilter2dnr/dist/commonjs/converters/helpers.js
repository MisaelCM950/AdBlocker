...
function normalizeFilter(filter, { mapping = exports.DEFAULT_PARAM_MAPPING } = {}) {
        ...
        declarativeNetRequest: {
            isRegexSupported: async (regexOptions, callback) => {
                try {
                    ...
                    new RE2Class(regexOptions.regex, regexOptions.isCaseSensitive ? 'u' : 'ui', MAX_MEMORY_BYTES);
